...
class CidadePageMap extends StatefulWidget {
  final Cidade cidade;

  CidadePageMap(this.cidade);

  @override
  CidadePageMapState createState() => CidadePageMapState();
}

class CidadePageMapState extends State<CidadePageMap> {
